...
def main():
    ...
    if st.session_state.mode == 'chat':
        ...
        st.write(
            "Hello! I'm your friendly chatbot. I can help answer your questions, provide information, or just chat. I'm also super fast! Let's start our conversation!")
        ...
        st.text_input("Ask a question:", value=st.session_state.user_question, key='user_question',
